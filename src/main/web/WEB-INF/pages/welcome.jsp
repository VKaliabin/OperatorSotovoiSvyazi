                ...
                <table class="table table-striped table-sm">
                    ...
                    <c:forEach items="${contracts}" var="contract">
                        <tr>
                            ...
                            <td>${contract.getTariff().getNameTariff()}</td>
                            <td>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${contract.getBlockedContract() == 'Unblocked'}">
                                        <a class="btn btn-lg btn-danger btn-block" href="/block?id=${contract.getIdContract()}">Block</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a class="btn btn-lg btn-primary btn-block " href="/unblock?id=${contract.getIdContract()}">Unblock</a>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                            <%--<td>sit</td>--%>
