        ...
        $("#search").bind('input', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    console.log(data.clientEntities);
...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
    ...
    <form class="form-inline my-1 my-md-6">
        <input class="form-control" name="search" id="search" type="number" placeholder="Search client">
    </form>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <%--<a class="btn btn-lg btn-danger" href="/block_client?id=${client.getIdClient()}"><i class="fa fa-minus-square" ></i></a>--%>
                    <%--</c:when>--%>
                    <%--<c:otherwise>--%>
                    <%--<a class="btn btn-lg btn-primary" href="/unblock_client?id=${client.getIdClient()}"><i class="fa fa-plus-square" ></i></a>--%>
                    <%--</c:otherwise>--%>
                    <%--</c:choose>--%>
                    <%--</c:if>--%>
