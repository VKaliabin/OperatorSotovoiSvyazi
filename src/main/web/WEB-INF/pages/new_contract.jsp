    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                <h1 class="h2" style="color: #ac2925">New contract with ${client.getName()} ${client.getSurname()}</h1>

            </div>


            <%--<h2>Section title</h2>--%>
            <form:form method="POST" action="addContract" modelAttribute="contract" class="form-signin">
                <input type="hidden" name="idClient" value="${client.getIdClient()}">
                <div class="row">
                    <spring:bind path="contractNumber">
                        <div class="col-md-3 mb-3">
                            <label for="contractNumber">New Number</label>
                            <form:input type="number" class="form-control" id="contractNumber"
                                        path="contractNumber" autofocus="true"/>
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="tariff">Choose a Tariff</label>
                ...
                <button class="btn btn-primary btn-block" style="width: 150px" type="submit">Make a contract</button>
            </form:form>
        </main>
    </div>
</div>
